...
local function UpdateAddonButton(MainFrame)
	...
	for i = Start, End do
		...
		Button:SetScript("OnEnter", function(self)
			...
			GameTooltip:AddLine(" ")
			GameTooltip:AddDoubleLine("|cffFFD700内存占用：|r", S.FormatMemory(AddonList[i]["Mem"]), 112/255, 192/255, 245/255, 1, 1, 1)
			GameTooltip:AddDoubleLine("|cffFFD700处理器占用：|r", AddonList[i]["Usage"].."%", 112/255, 192/255, 245/255, 1, 1, 1)
			GameTooltip:Show()
		end)
...
local function BuildGameMenuButton(Tittle)	
	...
	Button:SetText("|cffDDA0DD插件管理|r")
...
local function BuildMainFrame()
	...
	Tittle.Text:SetText("|cffDA70D6SunUI插件管理|r")
