...
Mod_AddonSkins:RegisterSkin("Omen",function(Skin, skin, Layout, layout, config)
	...
	Omen.UpdateBarTextureSettings = function(self)
		for i, v in ipairs(self.Bars) do
			v.texture:SetTexture(DB.Statusbar)
		end
	end
	-- Skin Bar fonts
	...
	Omen.UpdateBarLabelSettings = function(self)
		...
		for i, v in ipairs(self.Bars) do
			v.Text1:SetFont(DB.Font,self.db.profile.Bar.FontSize)
			v.Text2:SetFont(DB.Font,self.db.profile.Bar.FontSize)
			v.Text3:SetFont(DB.Font,self.db.profile.Bar.FontSize)
		end
	end
	-- Skin Title Bar
	...
	Omen.UpdateTitleBar = function(self)
		...
		self.TitleText:SetFont(DB.Font,self.db.profile.TitleBar.FontSize)
